...
import { IExplorerService, IFilesConfiguration, SortOrder, IExplorerView } from 'vs/workbench/common/filesScopeTree/files';
import { ExplorerItem, ExplorerModel } from 'vs/workbench/common/filesScopeTree/explorerModel';
